...
def print_rs(WCRS):
    ...
    """
    print(f"    {'File/Protocol':^44s}   {'Rs (Mohm)':^9s}   {'Comp Enabled':^12s}    {'Comp%':^10s}    {'RS delta %':^12s}    {'Cap (pF)':^9s}")
    for f in WCRS:
        ...
        cprint(col, f"    {short:<44s}   {f['WC']:9.2f}    {str(f['compEnabled']):^12s}    {f['compPct']:^9.1f}    {f['maxdelta']:10.2f}    {f['cap']:8.1f}")
