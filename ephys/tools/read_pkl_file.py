...
if __name__ == '__main__':
    ...
    pyrdatapath = Path(adpath, 'CBA_Age', 'pyramidal', '2023_01_27_S1C0_pyramidal_IVs.pkl')
    ...
    for k in d['Spikes'].keys():
        ...
        if (len(d['Spikes'][k]['LowestCurrentSpike']) > 0):
            ...
            # print("   ", k, "LCS AP height: ", d['Spikes'][k]['LowestCurrentSpike']['AP_peak_V'] - d['Spikes'][k]['LowestCurrentSpike']['AP_thr_V'])
            ...
            print("   ", f"{k:s}, trace: {tr:d} spike #: {sn:d}  peak V: {vpk:5.1f}, thr V: {vth:5.1f}, AP Height: {vpk-vth:5.1f}, current: {icurr:6.1f}")  # confirm that the threshold value is the same
